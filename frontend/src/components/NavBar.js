			...
			<div className="navbar-right">
				<button className="nav-button" title="Notifications">
					<svg viewBox="0 0 24 24" fill="none" className="nav-icon">
						...
						/>
						<path
							d="M5.58 18.25C5.09 18.15 4.66 17.86 4.37 17.45C4.08 17.05 3.95 16.55 4.01 16.05L5.01 7.94C5.27 6.27 6.11 4.75 7.4 3.66C8.69 2.57 10.32 1.98 12.01 2C13.7 1.98 15.33 2.57 16.62 3.66C17.91 4.75 18.76 6.27 19.01 7.94L20.01 16.05C20.07 16.55 19.95 17.05 19.66 17.45C19.37 17.86 18.94 18.14 18.45 18.25C14.22 19.24 9.81 19.24 5.58 18.25Z"
							stroke="currentColor"
							strokeWidth="1.5"
							strokeLinecap="round"
							strokeLinejoin="round"
				...
				<button className="nav-button" title="Profile">
					<svg viewBox="0 0 24 24" fill="none" className="nav-icon">
						<path
							d="M16 7C16 9.21 14.21 11 12 11C9.79 11 8 9.21 8 7C8 4.79 9.79 3 12 3C14.21 3 16 4.79 16 7Z"
							stroke="currentColor"
							strokeWidth="2"
							strokeLinecap="round"
							strokeLinejoin="round"
